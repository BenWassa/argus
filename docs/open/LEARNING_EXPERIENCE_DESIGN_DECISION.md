...
> sync, export, import, reset, and catalog-delivery status. Data is no longer a
> Library child; historical `data` history entries resolve to Profile. This block
> supersedes later statements and diagrams that place Data under Library.
