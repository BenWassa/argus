 ...
 * speed/WPM evidence. While a pointer is held the control sounds a neutral CW
 * sidetone for exactly the learner-generated press duration; that is motor
 * feedback, not target-answer playback. Keyboard users may use `.`, `-`,
 * Backspace and Enter without timing.
 */
export function MorseKeyInput({
  ...
  const stopTone = useCallback(() => {
    ...
    try {
      ...
      // Audio is optional motor feedback. Input must remain usable even if a
      // browser tears down Web Audio while the pointer is held.
    }
  }, [])
